...
namespace kaizer {
    ...
    extern std::unordered_map<std::string, std::unordered_map<std::string, std::unordered_map<std::string, Quirk*>>> quirkRegistry;

    extern std::unordered_map<std::string, std::vector<std::pair<std::pair<std::string_view, std::string_view>, std::unordered_map<std::string, Quirk*>>>> quirksCache;
