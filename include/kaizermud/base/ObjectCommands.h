...
namespace kaizer::base {
    ...
    struct ObjQuit : ObjCmd {
        [[nodiscard]] std::string_view getCmdName() override {return "quit";};
        void execute(entt::entity ent, std::unordered_map<std::string, std::string>& input) override;
    };
    ...
    struct ObjSay : ObjCmd {
        [[nodiscard]] std::string_view getCmdName() override { return "say"; };
        void execute(entt::entity ent, std::unordered_map<std::string, std::string> &input) override;
    };
    ...
    struct ObjPose : ObjCmd {
        [[nodiscard]] std::string_view getCmdName() override { return "pose"; };
    ...
    struct ObjSemipose : ObjCmd {
        [[nodiscard]] std::string_view getCmdName() override { return "semipose"; };
    ...
    struct ObjWhisper : ObjCmd {
        [[nodiscard]] std::string_view getCmdName() override { return "whisper"; };
        void execute(entt::entity ent, std::unordered_map<std::string, std::string> &input) override;
    };
    ...
    struct ObjShout : ObjCmd {
        [[nodiscard]] std::string_view getCmdName() override { return "shout"; };
    ...
    struct ObjGet : ObjCmd {
        [[nodiscard]] std::string_view getCmdName() override { return "get"; };
        void execute(entt::entity ent, std::unordered_map<std::string, std::string> &input) override;
    };
    ...
    struct ObjTake : ObjCmd {
        [[nodiscard]] std::string_view getCmdName() override { return "take"; };
        void execute(entt::entity ent, std::unordered_map<std::string, std::string> &input) override;
    };
    ...
    struct ObjPut : ObjCmd {
        [[nodiscard]] std::string_view getCmdName() override { return "put"; };
        void execute(entt::entity ent, std::unordered_map<std::string, std::string> &input) override;
    };
    ...
    struct ObjGive : ObjCmd {
        [[nodiscard]] std::string_view getCmdName() override { return "give"; };
        void execute(entt::entity ent, std::unordered_map<std::string, std::string> &input) override;
    };
    ...
    struct ObjDrop : ObjCmd {
        [[nodiscard]] std::string_view getCmdName() override { return "drop"; };
        void execute(entt::entity ent, std::unordered_map<std::string, std::string> &input) override;
    };
    ...
    struct ObjInventory : ObjCmd {
        [[nodiscard]] std::string_view getCmdName() override { return "inventory"; };
    ...
    struct ObjEquip : ObjCmd {
        [[nodiscard]] std::string_view getCmdName() override { return "equip"; };
